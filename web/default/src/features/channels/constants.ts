...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  ...
  18, 58, 45, 31, 35, 49, 19, 47, 37, 38, 39, 11, 8, 57, 22, 21, 44, 2, 5, 36, 50,
  51, 52, 53, 54, 55, 56,
]
...
export const CHANNEL_STATUS_CONFIG = {
  ...
  [CHANNEL_STATUS.RATE_LIMITED_429]: {
...
export const FIELD_PLACEHOLDERS = {
  ...
  GROUP_BLACKLIST: 'Select user groups to block from this channel.',
...
export const FIELD_DESCRIPTIONS = {
  ...
  GROUP_BLACKLIST:
    'Users in these groups cannot use this channel. Matched against the user account group, independent of the channel groups above.',
  MODEL_MAPPING:
  ...
  DISABLE_429_BAN:
    'When enabled, 429 responses skip auto rate-limiting and fallback, and follow normal retry logic (requires 429 to be included in the global retry status codes).',
