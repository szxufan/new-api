...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		perfMetricsRoute.Use(middleware.HeaderNavModulePublicOrUserAuth("pricing"))
		{
			...
			perfMetricsRoute.GET("/active", controller.GetActiveRequests)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/:id/rate-limit", controller.RateLimitChannel)
			channelRoute.POST("/:id/unrate-limit", controller.UnrateLimitChannel)
		...
		dataRoute.GET("/users/models", middleware.AdminAuth(), controller.GetQuotaDatesByUserAndModel)
