...
func InitOptionMap() {
	...
	common.OptionMap["RateLimit429Enabled"] = strconv.FormatBool(operation_setting.RateLimit429Enabled)
	common.OptionMap["RateLimit429DurationMinutes"] = strconv.Itoa(operation_setting.RateLimit429DurationMinutes)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "RetryIntervalMs":
		common.RetryIntervalMs, _ = strconv.Atoi(value)
	...
	case "RateLimit429Enabled":
		operation_setting.RateLimit429Enabled, _ = strconv.ParseBool(value)
	case "RateLimit429DurationMinutes":
		operation_setting.RateLimit429DurationMinutes, _ = strconv.Atoi(value)
	case "QuotaPerUnit":
